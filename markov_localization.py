...
config = {
    ...
    "ranger_noise_std_prop": 0.03, # Scaler that makes std deviation proportional to distance on range measurements (0 to 1)
...
class ParticleFilter():
    ...
    def resample(self):
        ...
        self.particles[:explore_particles] = np.random.uniform((0,0.1,0,0),(1,0.7,2*np.pi,0),(explore_particles,4))
